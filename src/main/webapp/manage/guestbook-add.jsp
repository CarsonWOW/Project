...
<jsp:include page="comm.jsp"></jsp:include>
	<div class="main">
		<h2>添加店面</h2>
		<div class="manage">
			<form action="showShop.shop" method="post" enctype="multipart/form-data">
				<table class="form">
					<tr>
						<td class="field">店面分类：</td>
						<td>
					...
					<tr>
						...
						<td><input type="text" class="text" name="shopName"  /></td>
					</tr>
					<tr>
						<td class="field">特色菜品：</td>
						<td><input type="text" class="text" name="shopCuisine"  /></td>
					</tr>
					<tr>
						<td class="field">营业时间：</td>
						<td><input type="text" class="text" name="shopBusiness"  /></td>
					</tr>
					<tr>
						<td class="field">停车泊位：</td>
						<td><input type="text" class="text" name="shopPark"  /></td>
					</tr>
					<tr>
						<td class="field">餐厅地址：</td>
						<td><input type="text" class="text" name="shopSite"  /></td>
					</tr>
					<tr>
						<td class="field">餐厅标签：</td>
						<td><input type="text" class="text" name="shopLabel"  /></td>
					</tr>
					<tr>
